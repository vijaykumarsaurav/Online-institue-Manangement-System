...
%>
<%	try{
ResultSet rs1=stmt.executeQuery("select COUNT(form_no) from student");
Boolean row=rs1.next();
int flag=0,c=1;
if(rs1.getInt(1)>=1)
{
ResultSet rs=stmt.executeQuery("select * from student");
out.println("<head><title BGCOLOR='RED'>course Details  </title></head>	<body bgcolor='pink'>				<br/><h1 style='text-align:center'>ALL COURSE DETAILS  </h2><center>	<table style='allign:left' BORDER='3' bordercolor='green' cellspacing='0' cellpadding ='4'><tr bgcolor='green'><td>Sr.no.</td><td>From No.</td><td>Name</td><td>Father's Name</td><td>Course</td><td>Batch </td><td>Mobile no.</td><td>Date of Joining</td></tr>");
...
while(rs.next())
{
					...
					out.println("<tr bgcolor='darer 25%'><td>"+c+"</td><td> <a href='student_display_form_wise.jsp?form_no="+rs.getString(1)+"'>"+rs.getString(1)+"</a></td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(11)+"</td><td>"+rs.getString(13)+"</td></tr>");
					flag=1;
					}	
					else
					{ 				
				out.println("<tr bgcolor='white'><td>"+c+"</td><td> <a href='student_display_form_wise.jsp?form_no="+rs.getString(1)+"'>"+rs.getString(1)+"</a></td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(11)+"</td><td>"+rs.getString(13)+"</td></tr>");
					flag=0;					
					}
					c=c+1;
}
