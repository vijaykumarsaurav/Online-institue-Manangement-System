...
<form action="http://localhost:8000/oims/couse_delete.jsp" method="post" onsubmit="return course_search()">
<center>
<fieldset style="width:auto;background:rgb(251,252,188);text-align:center">
<legend>Course delete Search </legend> 
</br></br>
<table border="1" cellpadding="5" cellspacing="5" width="400" height="250" bordercolor="red" style="background:rgb(240,240,170);">
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>COURSE  DELETE SEARCH</th></tr>
