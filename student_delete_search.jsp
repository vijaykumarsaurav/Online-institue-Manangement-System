...
<form action="http://localhost:8000/oims/student_delete.jsp" method="post" onsubmit="return check()">
<center>
...
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>STUDENT DELETE SEARCH</th></tr>

<tr><td style="text-align:center"><b>Select Form Number</b></td> <td style="text-align:center"> <select name="form_no" id="form_no"><option>Select</option>
<%!
