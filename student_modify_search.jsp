...
<form action="http://localhost:8000/oims/student_modify_load.jsp" method="post" onsubmit="return check()">
<center>
<fieldset style="width:auto;background:rgb(251,252,188);">
...
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>STUDENT  MODIFY SEARCH</th></tr>
