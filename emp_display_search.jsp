...
<form action="http://localhost:8000/oims/emp_display_emp_wise.jsp" method="post" onsubmit='return empcheck()'>
<center>
...
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>EMPLOYEE  SEARCH</th></tr>
