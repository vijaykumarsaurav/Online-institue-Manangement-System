...
<form action="http://localhost:8000/oims/batch_modify_load.jsp" method="post" onsubmit='return batch_search()'>
<center>
...
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>BATCH  MODIFY SEARCH</th></tr>

<tr><td style="text-align:center"><b>Course Code</b></td> <td style="text-align:center"> <select name="batch_name" id="batch_name"><option>Select Batch</option>
<%!
