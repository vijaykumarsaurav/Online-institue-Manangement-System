...
<head>
<title BGCOLOR="RED">Teacher</title>
<script type ="text/javascript" src="javascript.js"></script>
</head>
<form action="http://localhost:8000/oims/tea_salary_make.jsp" method="post" onsubmit="return teacheck()">
<center>
...
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>TEACHER SALARY PAID </th></tr>
