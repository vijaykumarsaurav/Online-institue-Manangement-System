...
<title BGCOLOR="RED">PAYMENT SEARCH</title>
<script type ="text/javascript" src="javascript.js"></script>
</head> 
<form action="http://localhost:8000/oims/student_payment_duration.jsp" method="post" onsubmit="return collectionval()">
<center>
<fieldset style="width:auto;background:rgb(251,252,188);text-align:center">
<legend>Payment Search </legend> 
</br></br>
<table border="1" cellpadding="5" cellspacing="5" width="400" height="250" bordercolor="red" style="background:rgb(240,240,170);">
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:18px"><b>UPDATED DURATION WISE PAYMENT</th></tr>
