...
<head>
<title BGCOLOR="RED">EMPLOYEE SEARCH</title>
<script type ="text/javascript" src="javascript.js"></script>
</head>
<form action="http://localhost:8000/oims/emp_salary_make.jsp" method="post" onsubmit="return empcheck()">
<center>
...
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>EMPLOYEE SALARY PAID </th></tr>
