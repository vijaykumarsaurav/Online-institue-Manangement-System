...
<HEAD>
<title BGCOLOR="RED">Employee Delete</title>
<script type ="text/javascript" src="javascript.js"></script>
</head>
<form action="http://localhost:8000/oims/emp_delete.jsp" method="post" onsubmit="return empcheck()">
<center>
<fieldset style="width:auto;background:rgb(251,252,188);text-align:center">
<legend>Employee delete Search </legend> 
</br></br>
<table border="1" cellpadding="5" cellspacing="5" width="400" height="250" bordercolor="red" style="background:rgb(240,240,170);">
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>EMPLOYEE  DELETE SEARCH</th></tr>

<tr><td style="text-align:center"><b>Select employee id</b></td> <td style="text-align:center"> <select name="emp_id" id="emp_id"><option>Select</option>
