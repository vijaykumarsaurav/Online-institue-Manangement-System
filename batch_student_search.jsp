...
<title BGCOLOR="RED">STUDENT SEARCH</title>
<script type ="text/javascript" src="javascript.js"></script>
</head> 
<form action="http://localhost:8000/oims/batch_student_show.jsp" method="post" onsubmit="return check()">
<center>
<fieldset style="width:auto;background:rgb(251,252,188);text-align:center">
<legend>Batch wise Student Search </legend> 
</br></br>
<table border="1" cellpadding="5" cellspacing="5" width="400" height="250" bordercolor="red" style="background:rgb(240,240,170);">
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>BATCH WISE STUDENT  DETAILS</th></tr>

<tr><td style="text-align:center"><b>Select Batch</b></td> <td style="text-align:center"> <select name="batch_name" id="batch_name"><option>Select</option>
<%!
