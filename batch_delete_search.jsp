...
<title BGCOLOR="RED">BATCH DELETE</title>
<script type ="text/javascript" src="javascript.js"></script>
</head>
<form action="http://localhost:8000/oims/batch_delete.jsp" method="post" onsubmit='return batch_search()'>
<center>
...
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>BATCH  DELETE SEARCH</th></tr>
