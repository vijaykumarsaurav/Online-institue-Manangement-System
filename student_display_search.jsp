...
<form action="http://localhost:8000/oims/student_display_form_wise.jsp" method="post" onsubmit="return check()">
<center>
...
<tr><th colspan="2" style="color:rgb(234,9,48);text-align:center;font-size:20px"><b>STUDENT  FULL DETAILS</th></tr>
